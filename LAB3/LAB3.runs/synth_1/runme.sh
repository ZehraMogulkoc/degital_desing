...
HD_PWD='C:/Users/Lenovo/LAB3/LAB3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_lab3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_lab3_wrapper.tcl
